 ...
 * includes/sidebar/sidebar_mantenimiento.php
 */
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column">
            <li class="nav-item"><a class="nav-link <?php echo $current_page == 'mantenimiento.php' ? 'active' : ''; ?>" href="<?php echo URL_BASE; ?>dashboard/ordenes_servicio/mantenimiento.php"><i class="bi bi-house-door"></i> Inicio</a></li>
