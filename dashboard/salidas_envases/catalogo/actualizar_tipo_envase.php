<?php
/**
 * Handler POST: actualiza nombre y estado activo de un tipo de envase.
 * dashboard/salidas_envases/catalogo/actualizar_tipo_envase.php
 */
...
$resultado = actualizar_tipo_envase($id, $nombre, $activo);
