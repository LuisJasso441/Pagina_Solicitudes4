<?php
/**
 * Handler POST: elimina un tipo de envase (y sus especificaciones en cascada).
 * dashboard/salidas_envases/catalogo/eliminar_tipo_envase.php
 */
...
if (!es_logistica()) {
    $_SESSION['flash_msg'] = 'No tienes permisos para eliminar del catálogo.';
...
$resultado = eliminar_tipo_envase($id);
