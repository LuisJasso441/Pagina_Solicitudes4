                ...
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <a href="<?php echo URL_BASE; ?>dashboard/vacaciones/nueva_solicitud_manual.php" class="btn btn-success btn-sm">
                                <i class="bi bi-plus-circle me-1"></i> Solicitud Manual
                            </a>
